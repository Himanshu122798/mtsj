...
public abstract class BaseWebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    ...
    "/security/**", "/services/rest/login", "/services/rest/logout", "/services/rest/dishmanagement/**",
    ...
    "/services/rest/bookingmanagement/v1/invitedguest/decline/**", "/hystrix.stream", "/api/turbine/stream",
    "/api/turbine/clusters" };
